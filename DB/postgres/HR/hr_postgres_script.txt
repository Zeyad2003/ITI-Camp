...
CREATE TABLE regions (
    region_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 5) PRIMARY KEY,
...
CREATE TABLE locations (
    location_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 3300 INCREMENT BY 100) PRIMARY KEY,
...
CREATE TABLE departments (
    department_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 300 INCREMENT BY 10) PRIMARY KEY,
...
CREATE TABLE employees (
    employee_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 220) PRIMARY KEY,
...
INSERT INTO employees VALUES 
    ...
    ( 131, 'James', 'Marlow', 'JAMRLOW', '650.124.7234', TO_DATE('16-FEB-1999', 'DD-MON-YYYY'), 'ST_CLERK', 2500, NULL, 121, 50 ),
    ...
    ( 136, 'Hazel', 'Philtanker', 'HPHILTA', '650.127.1634', TO_DATE('06-FEB-2000', 'DD-MON-YYYY'), 'ST_CLERK', 2200, NULL, 122, 50 ),
    ( 137, 'Renske', 'Ladwig', 'RLADWIG', '650.121.1234', TO_DATE('14-JUL-1997', 'DD-MON-YYYY'), 'ST_CLERK', 3600, NULL, 123, 50 ),
    ...
    ( 140, 'Joshua', 'Patel', 'JPATEL', '650.121.1834', TO_DATE('06-APR-1996', 'DD-MON-YYYY'), 'ST_CLERK', 2500, NULL, 123, 50 ),
    ...
    ( 148, 'Gerald', 'Cambrault', 'GCAMBRAU', '011.44.1344.619268', TO_DATE('15-OCT-1997', 'DD-MON-YYYY'), 'SA_MAN', 11000, 0.3, 100, 80 ),
    ( 149, 'Eleni', 'Zlotkey', 'EZLOTKEY', '011.44.1344.429018', TO_DATE('29-JAN-1998', 'DD-MON-YYYY'), 'SA_MAN', 10500, 0.2, 100, 80 ),
    ...
    ( 152, 'Peter', 'Hall', 'PHALL', '011.44.1344.478968', TO_DATE('20-AUG-1998', 'DD-MON-YYYY'), 'SA_REP', 9000, 0.25, 145, 80 ),
    ( 153, 'Christopher', 'Olsen', 'COLSEN', '011.44.1344.498718', TO_DATE('30-MAR-1999', 'DD-MON-YYYY'), 'SA_REP', 8000, 0.2, 145, 80 ),
    ( 154, 'Nanette', 'Cambrault', 'NCAMBRAU', '011.44.1344.987668', TO_DATE('09-DEC-1998', 'DD-MON-YYYY'), 'SA_REP', 7500, 0.2, 145, 80 ),
    ( 155, 'Oliver', 'Tuvault', 'OTUVAULT', '011.44.1344.486508', TO_DATE('23-NOV-1997', 'DD-MON-YYYY'), 'SA_REP', 7000, 0.15, 145, 80 ),
    ( 156, 'Janette', 'King', 'JKING', '011.44.1345.429268', TO_DATE('30-JAN-1998', 'DD-MON-YYYY'), 'SA_REP', 10000, 0.35, 146, 80 ),
    ...
    ( 160, 'Louise', 'Doran', 'LDORAN', '011.44.1345.629268', TO_DATE('15-DEC-1999', 'DD-MON-YYYY'), 'SA_REP', 7500, 0.3, 146, 80 ),
    ( 161, 'Sarath', 'Sewall', 'SSEWALL', '011.44.1345.929072', TO_DATE('03-AUG-1998', 'DD-MON-YYYY'), 'SA_REP', 7000, 0.25, 146, 80 ),
    ...
    (164, 'Mattea', 'Marvins', 'MMARVINS', '011.44.1346.329268', TO_DATE('24-SEP-1998', 'DD-MON-YYYY'), 'SA_REP', 7200, 0.1, 147, 80),
    (165, 'David', 'Lee', 'DLEE', '011.44.1346.529268', TO_DATE('23-FEB-1997', 'DD-MON-YYYY'), 'SA_REP', 6800, 0.1, 147, 80),
    (166, 'Sundar', 'Ande', 'SANDE', '011.44.1346.629268', TO_DATE('24-MAR-2000', 'DD-MON-YYYY'), 'SA_REP', 6400, 0.1, 147, 80),
    (167, 'Amit', 'Banda', 'ABANDA', '011.44.1346.729268', TO_DATE('21-APR-1996', 'DD-MON-YYYY'), 'SA_REP', 6200, 0.1, 147, 80),
    (168, 'Lisa', 'Ozer', 'LOZER', '011.44.1343.929268', TO_DATE('11-MAR-1997', 'DD-MON-YYYY'), 'SA_REP', 11500, 0.25, 148, 80),
    (169, 'Harrison', 'Bloom', 'HBLOOM', '011.44.1343.829268', TO_DATE('23-MAR-1999', 'DD-MON-YYYY'), 'SA_REP', 10000, 0.2, 148, 80),
    (170, 'Tayler', 'Fox', 'TFOX', '011.44.1343.729268', TO_DATE('24-JAN-1998', 'DD-MON-YYYY'), 'SA_REP', 9600, 0.2, 148, 80),
    (171, 'William', 'Smith', 'WSMITH', '011.44.1343.629268', TO_DATE('23-FEB-1996', 'DD-MON-YYYY'), 'SA_REP', 7400, 0.15, 148, 80),
    (172, 'Elizabeth', 'Bates', 'EBATES', '011.44.1343.529268', TO_DATE('24-MAR-1999', 'DD-MON-YYYY'), 'SA_REP', 7300, 0.15, 148, 80),
    (173, 'Sundita', 'Kumar', 'SKUMAR', '011.44.1343.329268', TO_DATE('21-APR-1998', 'DD-MON-YYYY'), 'SA_REP', 6100, 0.1, 148, 80),
    (174, 'Ellen', 'Abel', 'EABEL', '011.44.1644.429267', TO_DATE('11-MAY-1996', 'DD-MON-YYYY'), 'SA_REP', 11000, 0.3, 149, NULL),
    ...
    (177, 'Jack', 'Livingston', 'JLIVINGS', '011.44.1644.429264', TO_DATE('23-APR-1999', 'DD-MON-YYYY'), 'SA_REP', 8400, 0.2, 149, 80),
    (178, 'Kimberely', 'Grant', 'KGRANT', '011.44.1644.429263', TO_DATE('24-MAY-1999', 'DD-MON-YYYY'), 'SA_REP', 7000, 0.15, 149, 80),
    ...
    (183, 'Girard', 'Geoni', 'GGEONI', '650.507.9879', TO_DATE('03-FEB-1998', 'DD-MON-YYYY'), 'SH_CLERK', 2800, NULL, 120, 50),
    (184, 'Nandita', 'Sarchand', 'NSARCHAN', '650.509.1876', TO_DATE('27-JAN-1998', 'DD-MON-YYYY'), 'SH_CLERK', 4200, NULL, 121, 50),
    (185, 'Alexis', 'Bull', 'ABULL', '650.509.2876', TO_DATE('20-FEB-1998', 'DD-MON-YYYY'), 'SH_CLERK', 4100, NULL, 121, 50),
    (186, 'Julia', 'Dellinger', 'JDELLING', '650.509.3876', TO_DATE('24-JUN-1999', 'DD-MON-YYYY'), 'SH_CLERK', 3400, NULL, 121, 50),
    (187, 'Anthony', 'Cabrio', 'ACABRIO', '650.509.4876', TO_DATE('07-FEB-1997', 'DD-MON-YYYY'), 'SH_CLERK', 3000, NULL, 121, 50),
	  (188, 'Kelly', 'Chung', 'KCHUNG', '650.505.1876', TO_DATE('14-JUN-1999', 'DD-MON-YYYY'), 'SH_CLERK', 3800, NULL, 122, 50),
    (189, 'Jennifer', 'Dilly', 'JDILLY', '650.505.2876', TO_DATE('13-AUG-1999', 'DD-MON-YYYY'), 'SH_CLERK', 3600, NULL, 122, 50),
    (190, 'Timothy', 'Gates', 'TGATES', '650.505.3876', TO_DATE('11-JUL-1997', 'DD-MON-YYYY'), 'SH_CLERK', 2900, NULL, 122, 50),
    ...
    (195, 'Vance', 'Jones', 'VJONES', '650.501.4876', TO_DATE('17-AUG-1999', 'DD-MON-YYYY'), 'SH_CLERK', 2800, NULL, 123, 50),
...
VALUES 
    ...
    (201, TO_DATE('17-FEB-1996', 'DD-MON-YYYY'), TO_DATE('19-DEC-1999', 'DD-MON-YYYY'), 'MK_REP', 20),
...
-- Alter Table Add Foreign Key Mgr id
