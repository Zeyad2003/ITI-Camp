...
SECRET_KEY = 'django-insecure-ag)bq-atu-crbhhcct9tplqtnk3j*u!!db%%=5q)5*ju=**q4t'
...
INSTALLED_APPS = [
    ...
    'movies',
    # Lab 3: Monitoring & Profiling tools
    'debug_toolbar',
    'silk',
]
...
DATABASES = {
    'default': {
        ...
        # Lab 2: Connection pooling configuration
...
# ============================================================================
# LAB 3: MONITORING & PROFILING CONFIGURATION
# ============================================================================
